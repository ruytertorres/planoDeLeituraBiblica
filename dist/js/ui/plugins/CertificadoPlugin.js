...
exports.CertificadoPlugin = void 0;
const timestampUtil_js_1 = require("../../core/services/tempo/timestampUtil.js");
/**
...
class CertificadoPlugin {
    ...
    async init(mainOrquestrador) {
        ...
        if (btnCertificado) {
            mainOrquestrador.on(btnCertificado, "click", () => this.abrirModalCertificado());
        }
    ...
    podeGerar() {
        ...
        const agora = new Date((0, timestampUtil_js_1.getTimestampAtual)());
        const diasDecorridos = Math.floor((agora - dataInicio) / (1000 * 60 * 60 * 24));
    ...
    async gerarCertificado() {
        try {
            ...
            const dados = {
                ...
                plano: plano.nome,
                dataInicio: progresso.getDataInicio?.() || (0, timestampUtil_js_1.getTimestampAtual)(),
                dataFim: (0, timestampUtil_js_1.getTimestampAtual)(),
    ...
    criarHtmlCertificado(dados) {
        const dataInicioFormatada = (0, timestampUtil_js_1.formatarDataCertificado)(dados.dataInicio);
        const dataFimFormatada = (0, timestampUtil_js_1.formatarDataCertificado)(dados.dataFim);
        return `
      <div style="
        padding: 40px;
        text-align: center;
    ...
    `;
      ...
      font-size: 14px;
    `;
        btnBaixar.addEventListener("click", () => this.baixarCertificadoPDF(conteudo.innerHTML));
        // Botão fechar
    ...
    async baixarCertificadoPDF(htmlCertificado) {
        try {
            ...
            const opcoes = {
                margin: 10,
                filename: `certificado-${(0, timestampUtil_js_1.getTimestampAtual)()}.pdf`,
            ...
            this.mainOrquestrador.emit("certificado-baixado", {
                data: (0, timestampUtil_js_1.getTimestampAtual)(),
                tipo: "pdf",
            });
     ...
     */
    formatarData(data) {
        return (0, timestampUtil_js_1.formatarDataCertificado)(data);
    }
    /**
     * Cleanup do plugin
     * @public
...
exports.CertificadoPlugin = CertificadoPlugin;
