"use strict";
/* ============================================================================
   plano_cronologico.ts — MODELO REFATORADO (GUIA CANÔNICO)
...
--------------------------------------------------------------------------- */
const Dia_1 = require("../core/models/Dia");
const geradorDatas_1 = require("../core/services/tempo/geradorDatas");
/* ---------------------------------------------------------------------------
...
function criarDia(numero, dados) {
    ...
    const ano = (0, geradorDatas_1.getAnoAtual)();
    ...
    return new Dia_1.Dia({
        numero,
        ano,
        data: (0, geradorDatas_1.gerarDataISO)(numero, ano),
        dataFormatada: (0, geradorDatas_1.gerarDataBR)(numero, ano),
        antigoTestamento: trechos.filter((t) => t.testamento === "antigoTestamento"),
