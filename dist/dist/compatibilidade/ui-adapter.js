...
exports.uiAdapterGlobal = exports.UIAdapter = void 0;
exports.criarUIAdapter = criarUIAdapter;
exports.inicializarAdapter = inicializarAdapter;
exports.getUIAdapter = getUIAdapter;
const PlanoManager_1 = require("../core/services/planos/PlanoManager");
/* ============================================================================
   ADAPTER PRINCIPAL
============================================================================ */
/**
...
class UIAdapter {
    ...
    constructor(plano) {
        this.plano = plano;
        this.planoManager = new PlanoManager_1.PlanoManager(plano);
    }
    /* --------------------------------------------------------------------------
 ...
 */
exports.uiAdapterGlobal = null;
/**
 * Inicializa o adaptador global com um plano.
 *
 * @param plano - Plano a ser gerenciado
 */
function inicializarAdapter(plano) {
    exports.uiAdapterGlobal = criarUIAdapter(plano);
}
/**
...
function getUIAdapter() {
    return exports.uiAdapterGlobal;
}
