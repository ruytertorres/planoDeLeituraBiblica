...
const plano_cronologico_1 = __importDefault(require("../js/cartuchos/plano_cronologico"));
exports.planoCronologico = plano_cronologico_1.default;
...
function inicializarSistemaTypeScript() {
    try {
        ...
        if (!plano_cronologico_1.default || !plano_cronologico_1.default.id) {
            throw new Error("Plano cronológico inválido");
        }
        // Inicializar adaptador global para UI JavaScript
        (0, ui_adapter_1.inicializarAdapter)(plano_cronologico_1.default);
