...
exports.criarDia = criarDia;
const geradorDatas_1 = require("../services/tempo/geradorDatas");
/* ============================================================================
   TIPOS SUPORTADOS
============================================================================ */
 ...
 */
function criarDia(numero, ano, antigoTestamento = [], novoTestamento = [], livros = [], capitulos = [], versiculos = [], observacoes = "") {
    // Geração de datas delegada a geradorDatas (NÍVEL 2)
    const data = (0, geradorDatas_1.gerarDataISO)(numero, ano);
    const dataFormatada = (0, geradorDatas_1.gerarDataBR)(numero, ano);
    return new Dia({
        numero,
        ano,
        data,
...
class Dia {
    ...
    constructor(params) {
        ...
        this.#validarTrechos(params.antigoTestamento, exports.TIPOS_LEITURA.ANTIGO_TESTAMENTO);
        this.#validarTrechos(params.novoTestamento, exports.TIPOS_LEITURA.NOVO_TESTAMENTO);
        /* ----------------------------------------------------------------------
           ATRIBUIÇÃO IMUTÁVEL
        ---------------------------------------------------------------------- */
