...
export const TIPOS_LEITURA = Object.freeze({
  ANTIGO_TESTAMENTO: "antigoTestamento" as const,
  NOVO_TESTAMENTO: "novoTestamento" as const,
});
...
export class Dia {
  ...
  public readonly dataFormatada: string;
  public readonly antigoTestamento: readonly TrechoBiblico[];
  public readonly novoTestamento: readonly TrechoBiblico[];
  public readonly livros: readonly string[];
  public readonly capitulos: readonly number[];
  public readonly versiculos: readonly string[];
  ...
  constructor(params: {
    ...
    if (
      !Number.isInteger(params.numero) ||
      params.numero < 1 ||
      params.numero > 366
    ) {
    ...
    if (
      typeof params.dataFormatada !== "string" ||
    ...
    this.#validarTrechos(
      params.antigoTestamento,
      TIPOS_LEITURA.ANTIGO_TESTAMENTO,
    );
  ...
  #validarTrechos(trechos: TrechoBiblico[], tipo: TipoLeitura): void {
