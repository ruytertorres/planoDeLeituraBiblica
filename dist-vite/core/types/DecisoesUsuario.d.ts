 ...
 */
export type CategoriaDecisao = 'leitura' | 'navegacao' | 'configuracao' | 'reset' | 'reajuste' | 'exportacao' | 'importacao' | 'anotacoes';
/**
 ...
 */
export type DecisaoUsuario = DecisaoMarcarLido | DecisaoDesmarcarLido | DecisaoPularDia | DecisaoNavegarDia | DecisaoProximoDia | DecisaoDiaAnterior | DecisaoResetProgresso | DecisaoReajustarDatas | DecisaoAlterarConfiguracao | DecisaoAlterarTema | DecisaoCriarNota | DecisaoEditarNota | DecisaoRemoverNota | DecisaoExportarDados | DecisaoImportarDados;
/**
...
export interface ResultadoDecisao {
    ...
    readonly duracaoExecucao?: number;
}
//# sourceMappingURL=DecisoesUsuario.d.ts.map